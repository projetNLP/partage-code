...
def init_annotation():  # initialiser un dossier d'images avec les même questions enregistrées dans config.json
    ...
    # on met toutes les images dans le dictionnaire avec le dictionnaire des questions comme un sous-dictionnaire
    for count, question in enumerate(lire_fichier()[1]):
